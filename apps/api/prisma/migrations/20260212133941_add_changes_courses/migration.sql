/*
  ...
  - You are about to drop the column `duracion_s` on the `leccion` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE `curso` ADD COLUMN `que_aprenderas` JSON NULL,
    ADD COLUMN `video_preview_url` VARCHAR(255) NULL;

-- AlterTable
ALTER TABLE `leccion` DROP COLUMN `duracion_s`,
    ADD COLUMN `duracion` DOUBLE NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE `resena` MODIFY `producto_id` INTEGER NULL;
