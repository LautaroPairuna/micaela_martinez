/*
  ...
  - You are about to drop the column `precio_lista` on the `producto` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE `curso` ADD COLUMN `descuento` INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE `producto` DROP COLUMN `precio_lista`,
