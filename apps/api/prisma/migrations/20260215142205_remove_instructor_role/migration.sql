/*
  ...
  - You are about to drop the column `instructor_id` on the `curso` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `curso` DROP COLUMN `instructor_id`;

-- AlterTable
ALTER TABLE `notificacion` MODIFY `tipo` ENUM('respuesta_resena', 'like_resena', 'mencion', 'sistema', 'promocion', 'recordatorio') NOT NULL;

-- AlterTable
ALTER TABLE `preferencias_notificacion` ADD COLUMN `promociones` BOOLEAN NOT NULL DEFAULT true,
