/*
  ...
  - You are about to drop the column `orden` on the `categoria` table. All the data in the column will be lost.
  - You are about to drop the column `parent_id` on the `categoria` table. All the data in the column will be lost.
  - You are about to drop the column `orden` on the `marca` table. All the data in the column will be lost.
  - You are about to drop the column `parent_id` on the `modulo` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX `categoria_parent_id_orden_idx` ON `categoria`;

-- DropIndex
DROP INDEX `marca_orden_idx` ON `marca`;

-- DropIndex
DROP INDEX `modulo_parent_id_idx` ON `modulo`;

-- AlterTable
ALTER TABLE `categoria` DROP COLUMN `orden`,
    DROP COLUMN `parent_id`;

-- AlterTable
ALTER TABLE `marca` DROP COLUMN `orden`;

-- AlterTable
ALTER TABLE `modulo` DROP COLUMN `parent_id`,
